...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function createProductCard(product) {
        ...
        composeButton.addEventListener('click', (event) => {
            ...
            quantitySelector.style.display = 'flex'; // Show quantity selector
        ...
        function getSupplementsTotal() {
            ...
            qSyrupItems.forEach(item => {
                ...
                if (isNaN(price)) {
                    const priceText = item.querySelector('.pricesup')?.textContent || '';
        ...
        function updateAllPrices() {
            ...
            const total = (originalPrice + supplementTotal) * quantity;
            priceElement.textContent = `${total} dt`;
            const clonedPrice = supplementsSection.querySelector('.cloned-price');
            if (clonedPrice) clonedPrice.textContent = `${total} dt`;
        }
